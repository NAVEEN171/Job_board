...
const Herosection = () => {
  ...
  return (
    <div className="w-full xs:px-4 px-14 xs:py-3 py-[20px] text-center break-words">
      <h1 className="text-4xl xs:text-2xl xs:mt-0  mt-[40px] font-semibold text-[#0066cc] ">
        Build, Manage and Analyze Your
        <span className="text-[#3a90ff]"> Perfect Job Board</span>
      </h1>
      <h6 className="text-gray-500  mt-[30px] xs:text-xs  text-xl font-normal">
      ...
      <button
        ...
        className="bg-[#4AA3FA] mt-5 xs:text-base text-lg px-7 py-3 font-semibold rounded-lg text-white cursor-pointer shadow-md"
      >
        AI Resume Tailor 📝
      </button>
    </div>
