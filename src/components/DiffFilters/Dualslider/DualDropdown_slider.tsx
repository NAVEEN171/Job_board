...
const DualDropdown_slider:React.FC<Filtertype4> = ({setactiveDropdown,Slideprevalue,setSlideprevalue,switchname,activeDropdown,setSliderValue,sliderValue,root}) => {
  ...
  return (
    ...
    <div className='border relative flex items-center gap-[5px] border-[1px] border-[#C8C8C8] px-[15px] py-[8px] rounded-[8px] hover:border-[#3a90ff]'>
     ...
     { activeDropdown===root && <div id="salary-drop-down" className='drop-down-list drop-down-salary  rounded-md flex flex-col gap-[15px] py-[15px] px-[15px] bg-white absolute top-[55px] left-0 w-[350px] shadow-custom' style={{zIndex: 9999}}>
