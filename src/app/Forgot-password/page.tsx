      ...
      <div className="errorsshower px-3  absolute w-full top-2 flex flex-col items-center gap-[10px]">
        {errorshow && (
          <div
            ...
            className="text-lg  xs:text-base    border-4 border-white  bg-gradient-to-r from-blue-500/70 to-blue-600/70 py-4 px-4 text-white shadow-2xl rounded-[10px] backdrop-blur-sm"
          >
            {errorshow}
          </div>
        )}
      ...
      <div className="w-full  md:w-1/2 h-full flex items-center justify-center">
        <div className="bg-gradient-to-br w-[90%] sm:w-fit flex flex-col gap-[10px] from-white/50 to-white/30 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 px-[15px] sm:px-[30px] py-[20px]">
          ...
          <button
           ...
           bg-gradient-to-r mt-[10px] flex gap-2 items-center justify-center from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 font-semibold transition-all duration-300 shadow-lg shadow-blue-500/30`}
          >
            {isLoading && (
              <Oval
                height={20}
